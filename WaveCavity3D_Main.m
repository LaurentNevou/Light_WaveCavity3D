...
f0_min=1e11;         %% filter the solutions where the frequency is superior than (Hz)
f0_max=1e15;         %% filter the solutions where the frequency is inferior than (Hz)
nmodes=3;            %% number of solutions asked 

AbsorbingBoundaryCondition=0;     %% 0 or 1 (NOT AVAILABLE YET!!!)
...
Ny=18;                  %% Meshing point in y-direction
Nz=15;                  %% Meshing point in z-direction

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Choose your between the next 2 structures or build your own!
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PSI=abs(Ex(:,:,:,i)).^2;
    p = patch(isosurface(x*1e6,y*1e6,z*1e6,PSI,max(PSI(:))/6));
